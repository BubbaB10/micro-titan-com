...
const VENTURES: Record<string, {
  ...
  "sandwich-etc": {
    ...
    desc: "Order-ahead app for a Paris, TX sandwich shop. Customers order on their phone, get an SMS confirmation, and pick up. No commission, no app store, no middleman.",
    proof: "Built, connected, and live with real orders in under one week. Twilio SMS confirmed. Real customers, real orders.",
