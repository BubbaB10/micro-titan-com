...
export default function ValetPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a1628] text-[#f4f7fa]">
      ...
      {/* Proof section — gate story */}
      <section className="py-20 px-4 border-b border-[rgba(168,216,240,0.08)] bg-[#060e1a]">
        <div className="max-w-3xl mx-auto">
          <p className="text-xs font-semibold tracking-[0.25em] uppercase text-[#4fb8e8] mb-4">
            The proof record
          </p>
          <h2
            className="text-4xl sm:text-5xl font-[300] leading-tight tracking-tight text-[#f4f7fa] mb-6"
            style={{ fontFamily: "var(--font-mulish)" }}
          >
          ...
          <p className="text-lg text-[#a8d8f0] font-light leading-relaxed mb-14">
          ...
          <div className="flex flex-col gap-6 mb-14">
            {[
              ...
              },
              {
                ...
                body: "PASS means the work counts as complete. FAIL returns exactly what failed so it can be fixed. HALT means an integrity issue — leaked secret, removed test, out-of-scope edit — work stops and escalates. The agent cannot clear a HALT.",
              },
            ].map((s) => (
          ...
          <div className="flex flex-col gap-3 mb-14">
            {[
              ...
              },
              {
                ...
                detail: "Comparison engine proven per deploy (24 assertions on the math). Every statement parse reconciles extracted line amounts against the header totals and flags LOW_FIDELITY instead of guessing.",
                color: "#d97706",
              },
              {
                app: "Sandwich Etc.",
              ...
              },
              {
                ...
                detail: "Customer and order data probed on every deploy — anonymous reads must be rejected and the export endpoint must require the correct key.",
                color: "#7c3aed",
              },
            ].map((c) => (
              <div
