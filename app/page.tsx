...
<p className="fine-print">These services are not part of the current package.</p><Link className="button" href="/pricing#quote">Build your quote ↗</Link><p className="fine-print">Custom software, ad spend, photography, and video are separate. Scope and start date agreed before you commit.</p></div></section>
